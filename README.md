...
**Purpose:**  
This project analyzes global health and pharmaceutical spending (Year 2010–2022) in the context of aging populations, disease burden (DALYs), and health outcomes (Life Expectancy). The goal is to identify trends and inform evidence-based policy insights.
